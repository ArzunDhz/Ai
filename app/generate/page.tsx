      ...
      <section className="flex ">
        ...
        <div className="flex flex-col w-full space-x-4">
          ...
          <div className="flex space-x-4 ">
            <h1 className="p-1 mt-2 text-sm font-bold rounded-full text-purple-60 bg-primary w-fit">
          ...
          {/* image section */}
          <div className="flex justify-center mt-8 h-[500px] max-lg:w-[320px]   ">
            <div className="flex flex-col items-center justify-center h-full w-[500px] space-y-5 border-2  border-opacity-40 rounded-sm max-lg:w-full border-slate-400 ">
              <svg
